			...
			<div class="lift-step lift-step-4 <?php echo (!$step_completed[4] ? 'hidden' : '' ); ?>">
				...
				<p>
					<?php if ( !$step_completed[4] ): ?>
						<input type="button" value="Back" class="lift-prev-step lift-step-button button-primary"data-lift_step="prev" />
					<?php endif; ?>
					<a href="<?php echo admin_url( sprintf( 'options-general.php?page=%s', Lift_Admin_Old::STATUS_PAGE ) ); ?>" class="lift-admin-panel<?php echo ($step_completed[4] ? '-initial-completed' : ''); ?> button-primary">View Lift Search Dashboard</a> 
				</p>
			</div>
